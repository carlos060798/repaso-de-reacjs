...
import { getHeroeById } from "../helpers/getHeroe";
import { useMemo } from "react";

function Hero() {
  const {id}=useParams();
  const navigate=useNavigate();
  const  hero=useMemo(()=>getHeroeById(id),[id]) //useMemo memoriza el resultado de la funcion y solo se ejecuta cuando cambia el id
  console.log(hero);
